# -*- coding: utf-8 -*-
#
# Celestial documentation build configuration file, created by
# sphinx-quickstart on Fri Apr 24 10:17:06 2009.
#
...
sys.path.insert(0, os.path.abspath(os.path.join('..', 'astral')))
...
project = u'Astral'
copyright = u'2009-2014, Simon Kennedy'
...
# of the sidebar.
html_logo = os.path.join('_static', 'earth_sun.png')
...
latex_documents = [
  ('index', 'Astral.tex', u'Astral Documentation',
