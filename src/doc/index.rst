...
type required as the `rtype` parameter to :meth:`~astral.moon.phase`
...
Timezone groups such as Europe can be accessed via the :func:`group` function in the
:mod:`~astral.geocoder` module
...
Manila, Maputo, Maseru, Masqat, Mbabane, Mecca, Medina, Melbourne, Memphis, Mexico, Miami,
