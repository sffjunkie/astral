...
def test_LocationReprDefault():
    l = Location()
    assert l.__repr__() == "Greenwich/England, tz=Europe/London, lat=51.47, lon=-0.00"


def test_LocationReprFull():
    l = Location(LocationInfo("London", "England", "Europe/London", 51.68, -0.05, 3))
    assert l.__repr__() == "London/England, tz=Europe/London, lat=51.68, lon=-0.05"


def test_LocationReprNoRegion():
    l = Location(LocationInfo("London", None, "Europe/London", 51.68, -0.05, 3))
